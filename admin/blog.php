          ...
          <tr>
            <td>Blog Banner
              <div class="table_btn" >
                ...
                <a href="addblog-banner.php" class="btn btn-sm btn btn-primary" float="right">
              ...
              <tr>
                <td>Blog All Item
                  <div class="table_btn" >
                    ...
                    <a href="addblog-all-item.php" class="btn btn-sm btn btn-primary" float="right">
                      <i class="fa fa-plus-circle"></i> Add Blog All Item</a>
