    ...
    if($_SESSION['role']==1){
      ...
      if(!empty($_POST)){
        ...
        $insert="INSERT INTO about_team_title(about_team_title,about_team_subtitle) VALUES('$title','$subtitle')";
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <div class="form-group">
                <label for="" class="col-sm-3 control-label">Teams Title</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="title">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-3 control-label">Teams Subtitle</label>
                <div class="col-sm-8">
