<?php
    ...
    if(!empty($_POST)){
         ...
         $insert="INSERT INTO about_people_details(about_people_details_name,	about_people_details_title,	about_people_details_photo) VALUES('$aname','$title','$imageName')";
    	...
    	<div class="panel panel-primary">
            <div class="panel-heading">
                <div class="col-md-9 heading_title">
                  Add About People Information
                 </div>
                 <div class="col-md-3 text-right">
                 	<a href="allabout-people-details.php" class="btn btn-sm btn btn-primary"><i class="fa fa-th"></i> All About People Details</a>
                </div>
                <div class="clearfix"></div>
            </div>
          <div class="panel-body">
              <div class="form-group">
                <label for="" class="col-sm-3 control-label">People Name</label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <label for="" class="col-sm-3 control-label">People Image </label>
                <div class="col-sm-8">
