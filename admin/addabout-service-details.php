<?php
    ...
    if(!empty($_POST)){
         ...
         $insert="INSERT INTO about_service_details(about_service_details_title,about_service_details ) VALUES('$title','$details')";
    ...
    <div class="col-md-12">
    	...
    	<div class="panel panel-primary">
            <div class="panel-heading">
                <div class="col-md-9 heading_details">
                  Add About Service Details
                 </div>
          ...
          <div class="panel-body">
              ...
              <div class="form-group">
                <label for="" class="col-sm-3 control-label">Service details</label>
                <div class="col-sm-8">
