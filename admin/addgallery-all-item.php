<?php
    ...
    if(!empty($_FILES)){
         ...
         $insert="INSERT INTO gallery_all_item(gallery_all_item_photo) VALUES('$imageName')";
         if(mysqli_query($con,$insert)){
           move_uploaded_file($image['tmp_name'],'uploads/'.$imageName);
           echo "Gallery All Item Uploaded";
         }
         else{
           echo "Gallery All Item Upload failed!";
         }
    	...
    	<div class="panel panel-primary">
            <div class="panel-heading">
                <div class="col-md-9 heading_title">
                  Add gallery All Item
                 </div>
                 <div class="col-md-3 text-right">
                 	<a href="allgallery-all-item.php" class="btn btn-sm btn btn-primary"><i class="fa fa-th"></i>All Item Details</a>
                </div>
