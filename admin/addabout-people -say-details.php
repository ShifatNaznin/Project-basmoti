    ...
    if($_SESSION['role']==1){
      ...
      if(!empty($_POST)){
        ...
        $insert="INSERT INTO about_people_say_details(about_people_say_details) VALUES('$details')";
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              <div class="form-group">
                <label for="" class="col-sm-3 control-label">People Say Details</label>
                <div class="col-sm-8">
